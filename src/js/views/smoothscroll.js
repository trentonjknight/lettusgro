...
export const Smoothscroll = () => {
	...
	return (
		<>
			<div className="ogregreen">
				<div id="link1" className="text-center pt-5 mt-3 bgstraw">
					<h1>L E T T U S</h1>
					<div className="tight">
						<p className="comforta">
							A plant growth management application employing the Raspberry Pi and sensor technology to
				...
				<div className="card bg-light ">
					<div className="card-body">
						<blockquote className="blockquote mb-0">
							...
							<br />
							<p className="arima">
								Because microgreens are harvested soon after germination, all the nutrient content
								remain concentrated. What
								{"'"}s more is that they are a great source of beneficial plant compounds containing
								...
								<div className="col-md-8">
									<div className="card-body">
										...
										<p className="CT, arima fontIncrease">
											...
											Here at Lettus Gro farm, we
											{"'"}
											ve combined our expert analysis, backed by scientific data, into one small
											web-based resource, at your fingertips! but wait, where the real magic
											happens is; when a little tech is introduced in the form of, Raspberry Pi.
										</p>
										<p className="comforta">
											<small className="text-muted">
												Raspberry Pi is a low-cost credit card sized computer which allows for
												controlling electronic components, learn programming skills, build
							...
							<div className="card-img-overlay">
								<div className="bgcoloropacity2">
									<p className="comforta textsizing ">
										Lettus is a SMART garden monitoring system, complete with sensors for soil
										moisture, sunlight, air quality, temperature, and humidity. The Raspberry can
										send out alerts directly to the user, check to see if the ph is balanced in
										cases of hydrophonics cultivation, and much much more!
									</p>
								</div>
